...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname rescaled_solar_system_model) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define venus-info (make-planet 80 25))
(define venus (circle 7 "solid" "bisque"))

(define earth-info (make-planet 105 40))
(define earth (circle 8 "solid" "royalblue"))


(define moon-info (make-planet 15 3)) 
(define moon (circle 2 "solid" "lightgray"))


(define mars-info (make-planet 130 75))
(define mars (circle 5 "solid" "firebrick"))

(define jupiter-info (make-planet 180 150))
(define jupiter (circle 20 "solid" "burlywood"))

(define saturn-info (make-planet 235 250))
(define saturn (circle 17 "solid" "navajowhite"))
          
(define uranus-info (make-planet 305 400))
(define uranus (circle 12 "solid" "powderblue"))

(define neptune-info (make-planet 360 700))
(define neptune (circle 12 "solid" "blue"))

(define pluto-info (make-planet 410 900))
